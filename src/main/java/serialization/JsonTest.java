...
public class JsonTest {
    public static void main(String[] args) throws IOException {
        ...
        StudentJsonOutputStream outputStream = new StudentJsonOutputStream(new FileOutputStream(new File("students.json")));
        outputStream.writeStudents(list);
        outputStream.flush();
        outputStream.close();
        StudentJsonInputStream inputStream = new StudentJsonInputStream(new FileInputStream(new File("students.json")));
